...
extern short      fftInputBuffer[8][SRIO_MAX_MTU/2]  ;   //  move from char to short



extern short      fftOutputBuffer[8][SRIO_MAX_MTU/2]  ;   //  move from char to short


extern    float  x_ref_float[2*MAX_FFT_SIZE] ;
